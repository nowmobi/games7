...
function realClick(e) {
    ...
    t.css({
        ...
        width: n.width(),
        height: n.height()
    }), t.prop("href", e).prop("target", "_blank"), fireEvent(document.getElementById("rurl"), "click")
}
var units = [ 
"", 
 ]; 
...
function fireEvent(e, t) {
    ...
    if (e.dispatchEvent) {
        ...
        c.initEvent(t, !0, !0), c.synthetic = !0, e.dispatchEvent(c, !0)
    } else if (e.fireEvent) {
        var c = n.createEventObject();
        c.synthetic = !0, e.fireEvent("on" + t, c)
    }
}