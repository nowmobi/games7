...
flambe.embed = function(k, w) {
    ...
    for (h = 0; h < k.length; ++h) switch (r = k[h], (n = r.match(/\.(\w+)(\?|$)/)) && (n = n[1].toLowerCase()), n) {
        case "swf":
            if ((null == p || "flash" == p) && swfobject.hasFlashPlayerVersion(flambe.FLASH_VERSION)) return h = document.createElement("div"), h.id = w + "-swf", x.appendChild(h), "undefined" == typeof $flambe_expose && (window.$flambe_expose = function(h, n) {
        ...
        case "js":
            if (null == p || "html" == p)
                if (n = document.createElement("canvas"), "getContext" in n) return n.id = w + "-canvas", x.appendChild(n), flambe.canvas = n, h = document.createElement("script"), h.onload = function() {
                    flambe.canvas = null
            ...
            for (var b = 0; b < a; b++) {
                ...
                if (0 < e.pv[0]) {
                    ...
                    if (d)
                        ...
                        for (var i = {}, d = d.getElementsByTagName("param"), o = d.length, m = 0; m < o; m++) "movie" != d[m].getAttribute("name").toLowerCase() && (i[d[m].getAttribute("name")] = d[m].getAttribute("value"));
                        I(g, i, c, f)
                    } else U(d), f && f(g)
                } else if (z(c, !0), f) {
    ...
    function L(a, b, c) {
        ...
        if (g)
            if (typeof a.id == j && (a.id = c), e.ie && e.win) {
                ...
                for (h in b) b[h] != Object.prototype[h] && "movie" != h.toLowerCase() && (a = o, i = h, m = b[h], c = d.createElement("param"), c.setAttribute("name", i), c.setAttribute("value", m), a.appendChild(c));
    ...
    function Q(a, b, c, f) {
        if (!e.ie || !e.mac) {
            ...
            if (g) {
                ...
                f && (M = t = null);
                if (!t || M != c) f = d.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), t = g.appendChild(f), e.ie && e.win && typeof d.styleSheets != j && 0 < d.styleSheets.length && (t = d.styleSheets[d.styleSheets.length - 1]), M = c;
    ...
    var j = "undefined",
        ...
        e = function() {
            ...
            if (typeof v.plugins != j && typeof v.plugins["Shockwave Flash"] == s) {
                ...
                if (h && (i = h.GetVariable("$version"))) g = !0, i = i.split(" ")[1].split(","), e = [parseInt(i[0], 10), parseInt(i[1], 10), parseInt(i[2], 10)]
            } catch (m) {}
            return {
                w3: a,
                pv: e,
    ...
    return {
        ...
        embedSWF: function(a, b, c, d, g, h, i, o, m, k) {
            ...
            e.w3 && !(e.wk && 312 > e.wk) && a && b && c && d && g ? (z(b, !1), w(function() {
                ...
                if (E(g)) q = L(e, l, b), e.id == b && z(b, !0), p.success = !0, p.ref = q;
                else {
                    if (h && n()) {
                        e.data = h;
                        I(e, l, b, k);
