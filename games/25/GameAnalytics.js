(function(scope) {
    ...
    function(e) {
        ...
        function l() {}
        n = e.utilities || (e.utilities = {}), u = e.logging.GALogger, l.getHmac = function(e, n) {
            ...
            e = encodeURI(e);
            for (var n, t, i, r, s, a = "", o = 0, d = 0, u = 0; i = (n = e.charCodeAt(u++)) >> 2, r = (3 & n) << 4 | (t = e.charCodeAt(u++)) >> 4, s = (15 & t) << 2 | (o = e.charCodeAt(u++)) >> 6, d = 63 & o, isNaN(t) ? s = d = 64 : isNaN(o) && (d = 64), a = a + l.keyStr.charAt(i) + l.keyStr.charAt(r) + l.keyStr.charAt(s) + l.keyStr.charAt(d), n = t = o = 0, i = r = s = d = 0, u < e.length;);
            return a
        ...
        }, l.keyStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", t = l, n.GAUtilities = t
    }(gameanalytics = gameanalytics || {}),
    function(m) {
        ! function(e) {
    ...
    function(e) {
        ...
        n = e.state || (e.state = {}), r = e.validators.GAValidator, d = e.utilities.GAUtilities, u = e.logging.GALogger, l = e.store.GAStore, s = e.device.GADevice, c = e.store.EGAStore, t = e.store.EGAStoreArgsOperator, v.setUserId = function(e) {
            v.instance.userId = e, v.cacheIdentifier()
        }, v.getIdentifier = function() {
            return v.instance.identifier
        }, v.isInitialized = function() {
            return v.instance.initialized
        }, v.setInitialized = function(e) {
            v.instance.initialized = e
        }, v.getSessionStart = function() {
            return v.instance.sessionStart
        }, v.getSessionNum = function() {
            return v.instance.sessionNum
        }, v.getTransactionNum = function() {
            return v.instance.transactionNum
        }, v.getSessionId = function() {
            return v.instance.sessionId
        }, v.getCurrentCustomDimension01 = function() {
            return v.instance.currentCustomDimension01
        }, v.getCurrentCustomDimension02 = function() {
            return v.instance.currentCustomDimension02
        }, v.getCurrentCustomDimension03 = function() {
            return v.instance.currentCustomDimension03
        }, v.getGameKey = function() {
            return v.instance.gameKey
        }, v.getGameSecret = function() {
            return v.instance.gameSecret
        }, v.getAvailableCustomDimensions01 = function() {
            return v.instance.availableCustomDimensions01
        }, v.setAvailableCustomDimensions01 = function(e) {
            r.validateCustomDimensions(e) && (v.instance.availableCustomDimensions01 = e, v.validateAndFixCurrentDimensions(), u.i("Set available custom01 dimension values: (" + d.joinStringArray(e, ", ") + ")"))
        }, v.getAvailableCustomDimensions02 = function() {
            return v.instance.availableCustomDimensions02
        }, v.setAvailableCustomDimensions02 = function(e) {
            r.validateCustomDimensions(e) && (v.instance.availableCustomDimensions02 = e, v.validateAndFixCurrentDimensions(), u.i("Set available custom02 dimension values: (" + d.joinStringArray(e, ", ") + ")"))
        }, v.getAvailableCustomDimensions03 = function() {
            return v.instance.availableCustomDimensions03
        }, v.setAvailableCustomDimensions03 = function(e) {
            r.validateCustomDimensions(e) && (v.instance.availableCustomDimensions03 = e, v.validateAndFixCurrentDimensions(), u.i("Set available custom03 dimension values: (" + d.joinStringArray(e, ", ") + ")"))
        }, v.getAvailableResourceCurrencies = function() {
            return v.instance.availableResourceCurrencies
        }, v.setAvailableResourceCurrencies = function(e) {
            r.validateResourceCurrencies(e) && (v.instance.availableResourceCurrencies = e, u.i("Set available resource currencies: (" + d.joinStringArray(e, ", ") + ")"))
        }, v.getAvailableResourceItemTypes = function() {
            return v.instance.availableResourceItemTypes
        }, v.setAvailableResourceItemTypes = function(e) {
            r.validateResourceItemTypes(e) && (v.instance.availableResourceItemTypes = e, u.i("Set available resource item types: (" + d.joinStringArray(e, ", ") + ")"))
        }, v.getBuild = function() {
            return v.instance.build
        }, v.setBuild = function(e) {
            v.instance.build = e, u.i("Set build version: " + e)
        }, v.getUseManualSessionHandling = function() {
            return v.instance.useManualSessionHandling
        }, v.isEventSubmissionEnabled = function() {
            return v.instance._isEventSubmissionEnabled
        }, v.getABTestingId = function() {
            return v.instance.abId
        }, v.getABTestingVariantId = function() {
            return v.instance.abVariantId
        }, v.prototype.setDefaultId = function(e) {
            this.defaultUserId = e || "", v.cacheIdentifier()
        }, v.getDefaultId = function() {
            return v.instance.defaultUserId
        }, v.getSdkConfig = function() {
            var e, n = 0;
            for (var t in v.instance.sdkConfig) 0 === n && (e = t), ++n;
            if (e && 0 < n) return v.instance.sdkConfig;
            for (var t in n = 0, v.instance.sdkConfigCached) 0 === n && (e = t), ++n;
            return e && 0 < n ? v.instance.sdkConfigCached : v.instance.sdkConfigDefault
        }, v.isEnabled = function() {
            return !!v.instance.initAuthorized
        }, v.setCustomDimension01 = function(e) {
            v.instance.currentCustomDimension01 = e, l.setItem(v.getGameKey(), v.Dimension01Key, e), u.i("Set custom01 dimension value: " + e)
        }, v.setCustomDimension02 = function(e) {
            v.instance.currentCustomDimension02 = e, l.setItem(v.getGameKey(), v.Dimension02Key, e), u.i("Set custom02 dimension value: " + e)
        }, v.setCustomDimension03 = function(e) {
            v.instance.currentCustomDimension03 = e, l.setItem(v.getGameKey(), v.Dimension03Key, e), u.i("Set custom03 dimension value: " + e)
        }, v.incrementSessionNum = function() {
            var e = v.getSessionNum() + 1;
            v.instance.sessionNum = e
        }, v.incrementTransactionNum = function() {
            var e = v.getTransactionNum() + 1;
            v.instance.transactionNum = e
        }, v.incrementProgressionTries = function(e) {
            var n = v.getProgressionTries(e) + 1;
            v.instance.progressionTries[e] = n;
            var t = {};
            t.progression = e, t.tries = n, l.insert(c.Progression, t, !0, "progression")
        }, v.getProgressionTries = function(e) {
            return e in v.instance.progressionTries ? v.instance.progressionTries[e] : 0
        }, v.clearProgressionTries = function(e) {
            e in v.instance.progressionTries && delete v.instance.progressionTries[e];
            var n = [];
            n.push(["progression", t.Equal, e]), l.delete(c.Progression, n)
        }, v.setKeys = function(e, n) {
            v.instance.gameKey = e, v.instance.gameSecret = n
        }, v.setManualSessionHandling = function(e) {
            v.instance.useManualSessionHandling = e, u.i("Use manual session handling: " + e)
        }, v.setEnabledEventSubmission = function(e) {
            v.instance._isEventSubmissionEnabled = e
        }, v.getEventAnnotations = function() {
            var e = {
                v: 2
            };
            e.user_id = v.instance.identifier, e.client_ts = v.getClientTsAdjusted(), e.sdk_version = s.getRelevantSdkVersion(), e.os_version = s.osVersion, e.manufacturer = s.deviceManufacturer, e.device = s.deviceModel, e.browser_version = s.browserVersion, e.platform = s.buildPlatform, e.session_id = v.instance.sessionId, e[v.SessionNumKey] = v.instance.sessionNum;
            var n = s.getConnectionType();
            if (r.validateConnectionType(n) && (e.connection_type = n), s.gameEngineVersion && (e.engine_version = s.gameEngineVersion), v.instance.configurations) {
                var t = 0;
                for (var i in v.instance.configurations) {
                    t++;
                    break
                }
                0 < t && (e.configurations = v.instance.configurations)
            }
            return v.instance.abId && (e.ab_id = v.instance.abId), v.instance.abVariantId && (e.ab_variant_id = v.instance.abVariantId), v.instance.build && (e.build = v.instance.build), e
        }, v.getSdkErrorEventAnnotations = function() {
            var e = {
                v: 2
            };
            e.category = v.CategorySdkError, e.sdk_version = s.getRelevantSdkVersion(), e.os_version = s.osVersion, e.manufacturer = s.deviceManufacturer, e.device = s.deviceModel, e.platform = s.buildPlatform;
            var n = s.getConnectionType();
            return r.validateConnectionType(n) && (e.connection_type = n), s.gameEngineVersion && (e.engine_version = s.gameEngineVersion), e
        }, v.getInitAnnotations = function() {
            var e = {};
            return v.getIdentifier() || v.cacheIdentifier(), l.setItem(v.getGameKey(), v.LastUsedIdentifierKey, v.getIdentifier()), e.user_id = v.getIdentifier(), e.sdk_version = s.getRelevantSdkVersion(), e.os_version = s.osVersion, e.platform = s.buildPlatform, v.getBuild() ? e.build = v.getBuild() : e.build = null, e.session_num = v.getSessionNum(), e.random_salt = v.getSessionNum(), e
        }, v.getClientTsAdjusted = function() {
            var e = d.timeIntervalSince1970(),
                n = e + v.instance.clientServerTimeOffset;
            return r.validateClientTs(n) ? n : e
        }, v.sessionIsStarted = function() {
            return 0 != v.instance.sessionStart
        }, v.cacheIdentifier = function() {
            v.instance.userId ? v.instance.identifier = v.instance.userId : v.instance.defaultUserId && (v.instance.identifier = v.instance.defaultUserId)
        }, v.ensurePersistedStates = function() {
            l.isStorageAvailable() && l.load(v.getGameKey());
            var e = v.instance;
            e.setDefaultId(null != l.getItem(v.getGameKey(), v.DefaultUserIdKey) ? l.getItem(v.getGameKey(), v.DefaultUserIdKey) : d.createGuid()), e.sessionNum = null != l.getItem(v.getGameKey(), v.SessionNumKey) ? Number(l.getItem(v.getGameKey(), v.SessionNumKey)) : 0, e.transactionNum = null != l.getItem(v.getGameKey(), v.TransactionNumKey) ? Number(l.getItem(v.getGameKey(), v.TransactionNumKey)) : 0, e.currentCustomDimension01 ? l.setItem(v.getGameKey(), v.Dimension01Key, e.currentCustomDimension01) : (e.currentCustomDimension01 = null != l.getItem(v.getGameKey(), v.Dimension01Key) ? l.getItem(v.getGameKey(), v.Dimension01Key) : "", e.currentCustomDimension01), e.currentCustomDimension02 ? l.setItem(v.getGameKey(), v.Dimension02Key, e.currentCustomDimension02) : (e.currentCustomDimension02 = null != l.getItem(v.getGameKey(), v.Dimension02Key) ? l.getItem(v.getGameKey(), v.Dimension02Key) : "", e.currentCustomDimension02), e.currentCustomDimension03 ? l.setItem(v.getGameKey(), v.Dimension03Key, e.currentCustomDimension03) : (e.currentCustomDimension03 = null != l.getItem(v.getGameKey(), v.Dimension03Key) ? l.getItem(v.getGameKey(), v.Dimension03Key) : "", e.currentCustomDimension03);
            var n = null != l.getItem(v.getGameKey(), v.SdkConfigCachedKey) ? l.getItem(v.getGameKey(), v.SdkConfigCachedKey) : "";
            if (n) {
                var t = JSON.parse(d.decode64(n));
                if (t) {
                    var i = l.getItem(v.getGameKey(), v.LastUsedIdentifierKey);
                    null != i && i != v.getIdentifier() && (u.w("New identifier spotted compared to last one used, clearing cached configs hash!!"), t.configs_hash && delete t.configs_hash), e.sdkConfigCached = t
                }
            }
            var r = v.getSdkConfig();
            e.configsHash = r.configs_hash ? r.configs_hash : "", e.abId = r.ab_id ? r.ab_id : "", e.abVariantId = r.ab_variant_id ? r.ab_variant_id : "";
            var s = l.select(c.Progression);
            if (s)
                for (var a = 0; a < s.length; ++a) {
                    var o = s[a];
                    o && (e.progressionTries[o.progression] = o.tries)
                }
        }, v.calculateServerTimeOffset = function(e) {
            return e - d.timeIntervalSince1970()
        }, v.validateAndCleanCustomFields = function(e) {
            var n = {};
            if (e) {
                var t = 0;
                for (var i in e) {
                    var r = e[i];
                    if (i && r)
                        if (t < v.MAX_CUSTOM_FIELDS_COUNT) {
                            var s = new RegExp("^[a-zA-Z0-9_]{1," + v.MAX_CUSTOM_FIELDS_KEY_LENGTH + "}$");
                            if (d.stringMatch(i, s)) {
                                var a = typeof r;
                                if ("string" == a || r instanceof String) r.length <= v.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH && 0 < r.length ? (n[i] = r, ++t) : u.w("validateAndCleanCustomFields: entry with key=" + i + ", value=" + r + " has been omitted because its value is an empty string or exceeds the max number of characters (" + v.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH + ")");
                            ...
                            } else u.w("validateAndCleanCustomFields: entry with key=" + i + ", value=" + r + " has been omitted because its key contains illegal character, is empty or exceeds the max number of characters (" + v.MAX_CUSTOM_FIELDS_KEY_LENGTH + ")")
                        } else u.w("validateAndCleanCustomFields: entry with key=" + i + ", value=" + r + " has been omitted because it exceeds the max number of custom fields (" + v.MAX_CUSTOM_FIELDS_COUNT + ")");
                    else u.w("validateAndCleanCustomFields: entry with key=" + i + ", value=" + r + " has been omitted because its key or value is null")
                }
            }
            return n
        }, v.validateAndFixCurrentDimensions = function() {
            r.validateDimension01(v.getCurrentCustomDimension01(), v.getAvailableCustomDimensions01()) || v.setCustomDimension01(""), r.validateDimension02(v.getCurrentCustomDimension02(), v.getAvailableCustomDimensions02()) || v.setCustomDimension02(""), r.validateDimension03(v.getCurrentCustomDimension03(), v.getAvailableCustomDimensions03()) || v.setCustomDimension03("")
        }, v.getConfigurationStringValue = function(e, n) {
            return v.instance.configurations[e] ? v.instance.configurations[e].toString() : n
        }, v.isRemoteConfigsReady = function() {
            return v.instance.remoteConfigsIsReady
        }, v.addRemoteConfigsListener = function(e) {
            v.instance.remoteConfigsListeners.indexOf(e) < 0 && v.instance.remoteConfigsListeners.push(e)
        }, v.removeRemoteConfigsListener = function(e) {
            var n = v.instance.remoteConfigsListeners.indexOf(e); - 1 < n && v.instance.remoteConfigsListeners.splice(n, 1)
        }, v.getRemoteConfigsContentAsString = function() {
            return JSON.stringify(v.instance.configurations)
        }, v.populateConfigurations = function(e) {
            var n = e.configs;
            if (n) {
                v.instance.configurations = {};
                for (var t = 0; t < n.length; ++t) {
                    ...
                    if (i) {
                        var r = i.key,
                            ...
                            d = v.getClientTsAdjusted();
                        r && s && a < d && d < o && (v.instance.configurations[r] = s)
                    }
                }
            }
            v.instance.remoteConfigsIsReady = !0;
            var u = v.instance.remoteConfigsListeners;
            for (t = 0; t < u.length; ++t) u[t] && u[t].onRemoteConfigsUpdated()
        }, v.addOnBeforeUnloadListener = function(e) {
            v.instance.beforeUnloadListeners.indexOf(e) < 0 && v.instance.beforeUnloadListeners.push(e)
        }, v.removeOnBeforeUnloadListener = function(e) {
            var n = v.instance.beforeUnloadListeners.indexOf(e); - 1 < n && v.instance.beforeUnloadListeners.splice(n, 1)
        }, v.notifyBeforeUnloadListeners = function() {
            for (var e = v.instance.beforeUnloadListeners, n = 0; n < e.length; ++n) e[n] && e[n].onBeforeUnload()
        }, v.CategorySdkError = "sdk_error", v.MAX_CUSTOM_FIELDS_COUNT = 50, v.MAX_CUSTOM_FIELDS_KEY_LENGTH = 64, v.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH = 256, v.instance = new v, v.DefaultUserIdKey = "default_user_id", v.SessionNumKey = "session_num", v.TransactionNumKey = "transaction_num", v.Dimension01Key = "dimension01", v.Dimension02Key = "dimension02", v.Dimension03Key = "dimension03", v.SdkConfigCachedKey = "sdk_config_cached", v.LastUsedIdentifierKey = "last_used_identifier", i = v, n.GAState = i
    }(gameanalytics = gameanalytics || {}),
    function(e) {
        var n, o, d, t;
    ...
    function(e) {
        ...
        l = e.http || (e.http = {}), p = e.state.GAState, S = e.logging.GALogger, c = e.utilities.GAUtilities, A = e.validators.GAValidator, h = e.tasks.SdkErrorTask, v = e.events.EGASdkErrorCategory, g = e.events.EGASdkErrorArea, f = e.events.EGASdkErrorAction, m = e.events.EGASdkErrorParameter, y.prototype.requestInit = function(e, n) {
            ...
            return t ? 200 === e ? l.EGAHTTPApiResponse.Ok : 201 === e ? l.EGAHTTPApiResponse.Created : 0 === e || 401 === e ? l.EGAHTTPApiResponse.Unauthorized : 400 === e ? l.EGAHTTPApiResponse.BadRequest : 500 === e ? l.EGAHTTPApiResponse.InternalServerError : l.EGAHTTPApiResponse.UnknownResponseCode : l.EGAHTTPApiResponse.NoResponse
    ...
    function(g) {
        ...
        f = g.events || (g.events = {}), m = g.store.GAStore, E = g.store.EGAStore, p = g.store.EGAStoreArgsOperator, S = g.state.GAState, A = g.logging.GALogger, h = g.utilities.GAUtilities, u = g.http.EGAHTTPApiResponse, y = g.http.GAHTTPApi, b = g.validators.GAValidator, C.addSessionStartEvent = function() {
            ...
            if (S.isEventSubmissionEnabled()) try {
                ...
                A.e("Error during ProcessEvents(): " + e.stack), y.instance.sendSdkErrorEvent(f.EGASdkErrorCategory.Json, f.EGASdkErrorArea.ProcessEvents, f.EGASdkErrorAction.JsonError, f.EGASdkErrorParameter.Undefined, e.stack, S.getGameKey(), S.getGameSecret())
            }
            ...
            if (S.isEventSubmissionEnabled())
                if (S.isInitialized()) try {
                    ...
                    A.e("addEventToStore: error"), A.e(i.stack), y.instance.sendSdkErrorEvent(f.EGASdkErrorCategory.Database, f.EGASdkErrorArea.AddEventsToStore, f.EGASdkErrorAction.DatabaseTooLarge, f.EGASdkErrorParameter.Undefined, i.stack, S.getGameKey(), S.getGameSecret())
        ...
        }, C.CategorySessionStart = "user", C.CategorySessionEnd = "session_end", C.CategoryDesign = "design", C.CategoryBusiness = "business", C.CategoryProgression = "progression", C.CategoryResource = "resource", C.CategoryError = "error", C.CategoryAds = "ads", C.MaxEventCount = 500, e = C, f.GAEvents = e
    }(gameanalytics = gameanalytics || {}),
    function(e) {
        var r, n, t, i, s;
    ...
    function(o) {
        var d = o.threading.GAThreading,
            u = o.logging.GALogger,
            l = o.store.GAStore,
            c = o.state.GAState,
            e = o.http.GAHTTPApi,
            v = o.device.GADevice,
            i = o.validators.GAValidator,
            g = o.http.EGAHTTPApiResponse,
            f = o.utilities.GAUtilities,
            m = o.events.GAEvents,
            n = (E.getGlobalObject = function() {
                ...
                window.addEventListener("beforeunload", function(e) {
                    console.log("addEventListener unload"), c.instance.isUnloading = !0, c.notifyBeforeUnloadListeners(), d.endSessionAndStopQueue(), c.instance.isUnloading = !1
                })
            }, E.gaCommand = function() {
                for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
                0 < e.length && e[0] in o.GameAnalytics.methodMap && (1 < e.length ? o.GameAnalytics.methodMap[e[0]].apply(null, Array.prototype.slice.call(e, 1)) : o.GameAnalytics.methodMap[e[0]]())
            }, E.configureAvailableCustomDimensions01 = function(e) {
                void 0 === e && (e = []), d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !1) ? u.w("Available custom dimensions must be set before SDK is initialized") : c.setAvailableCustomDimensions01(e)
                })
            }, E.configureAvailableCustomDimensions02 = function(e) {
                void 0 === e && (e = []), d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !1) ? u.w("Available custom dimensions must be set before SDK is initialized") : c.setAvailableCustomDimensions02(e)
                })
            }, E.configureAvailableCustomDimensions03 = function(e) {
                void 0 === e && (e = []), d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !1) ? u.w("Available custom dimensions must be set before SDK is initialized") : c.setAvailableCustomDimensions03(e)
                })
            }, E.configureAvailableResourceCurrencies = function(e) {
                void 0 === e && (e = []), d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !1) ? u.w("Available resource currencies must be set before SDK is initialized") : c.setAvailableResourceCurrencies(e)
                })
            }, E.configureAvailableResourceItemTypes = function(e) {
                void 0 === e && (e = []), d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !1) ? u.w("Available resource item types must be set before SDK is initialized") : c.setAvailableResourceItemTypes(e)
                })
            }, E.configureBuild = function(e) {
                void 0 === e && (e = ""), d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !1) ? u.w("Build version must be set before SDK is initialized.") : i.validateBuild(e) ? c.setBuild(e) : u.i("Validation fail - configure build: Cannot be null, empty or above 32 length. String: " + e)
                })
            }, E.configureSdkGameEngineVersion = function(e) {
                void 0 === e && (e = ""), d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !1) || (i.validateSdkWrapperVersion(e) ? v.sdkGameEngineVersion = e : u.i("Validation fail - configure sdk version: Sdk version not supported. String: " + e))
                })
            }, E.configureGameEngineVersion = function(e) {
                void 0 === e && (e = ""), d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !1) || (i.validateEngineVersion(e) ? v.gameEngineVersion = e : u.i("Validation fail - configure game engine version: Game engine version not supported. String: " + e))
                })
            }, E.configureUserId = function(e) {
                void 0 === e && (e = ""), d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !1) ? u.w("A custom user id must be set before SDK is initialized.") : i.validateUserId(e) ? c.setUserId(e) : u.i("Validation fail - configure user_id: Cannot be null, empty or above 64 length. Will use default user_id method. Used string: " + e)
                })
            }, E.initialize = function(e, n) {
                void 0 === e && (e = ""), void 0 === n && (n = ""), v.updateConnectionType();
                var t = d.createTimedBlock();
                t.async = !0, E.initTimedBlockId = t.id, t.block = function() {
                    E.isSdkReady(!0, !1) ? u.w("SDK already initialized. Can only be called once.") : i.validateKeys(e, n) ? (c.setKeys(e, n), E.internalInitialize()) : u.w("SDK failed initialize. Game key or secret key is invalid. Can only contain characters A-z 0-9, gameKey is 32 length, gameSecret is 40 length. Failed keys - gameKey: " + e + ", secretKey: " + n)
                }, d.performTimedBlockOnGAThread(t)
            }, E.addBusinessEvent = function(e, n, t, i, r, s) {
                if (void 0 === e && (e = ""), void 0 === n && (n = 0), void 0 === t && (t = ""), void 0 === i && (i = ""), void 0 === r && (r = ""), void 0 === s && (s = {}), v.updateConnectionType(), c.instance.isUnloading) {
                    if (!E.isSdkReady(!0, !0, "Could not add business event")) return;
                    m.addBusinessEvent(e, n, t, i, r, s)
                } else d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !0, "Could not add business event") && m.addBusinessEvent(e, n, t, i, r, s)
                })
            }, E.addResourceEvent = function(e, n, t, i, r, s) {
                if (void 0 === e && (e = o.EGAResourceFlowType.Undefined), void 0 === n && (n = ""), void 0 === t && (t = 0), void 0 === i && (i = ""), void 0 === r && (r = ""), void 0 === s && (s = {}), v.updateConnectionType(), c.instance.isUnloading) {
                    if (!E.isSdkReady(!0, !0, "Could not add resource event")) return;
                    m.addResourceEvent(e, n, t, i, r, s)
                } else d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !0, "Could not add resource event") && m.addResourceEvent(e, n, t, i, r, s)
                })
            }, E.addProgressionEvent = function(n, t, i, r, s, a) {
                if (void 0 === n && (n = o.EGAProgressionStatus.Undefined), void 0 === t && (t = ""), void 0 === i && (i = ""), void 0 === r && (r = ""), void 0 === a && (a = {}), v.updateConnectionType(), c.instance.isUnloading) {
                    if (!E.isSdkReady(!0, !0, "Could not add progression event")) return;
                    var e = "number" == typeof s;
                    "object" == typeof s && (a = s), m.addProgressionEvent(n, t, i, r, e ? s : 0, e, a)
                } else d.performTaskOnGAThread(function() {
            ...
            }, E.addDesignEvent = function(n, t, i) {
                if (void 0 === i && (i = {}), v.updateConnectionType(), c.instance.isUnloading) {
                    if (!E.isSdkReady(!0, !0, "Could not add design event")) return;
                    var e = "number" == typeof t;
                    "object" == typeof t && (i = t), m.addDesignEvent(n, e ? t : 0, e, i)
                } else d.performTaskOnGAThread(function() {
            ...
            }, E.addErrorEvent = function(e, n, t) {
                if (void 0 === e && (e = o.EGAErrorSeverity.Undefined), void 0 === n && (n = ""), void 0 === t && (t = {}), v.updateConnectionType(), c.instance.isUnloading) {
                    if (!E.isSdkReady(!0, !0, "Could not add error event")) return;
                    m.addErrorEvent(e, n, t)
                } else d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !0, "Could not add error event") && m.addErrorEvent(e, n, t)
                })
            }, E.addAdEventWithNoAdReason = function(e, n, t, i, r, s) {
                if (void 0 === e && (e = o.EGAAdAction.Undefined), void 0 === n && (n = o.EGAAdType.Undefined), void 0 === t && (t = ""), void 0 === i && (i = ""), void 0 === r && (r = o.EGAAdError.Undefined), void 0 === s && (s = {}), v.updateConnectionType(), c.instance.isUnloading) {
                    if (!E.isSdkReady(!0, !0, "Could not add ad event")) return;
                    m.addAdEvent(e, n, t, i, r, 0, !1, s)
                } else d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !0, "Could not add ad event") && m.addAdEvent(e, n, t, i, r, 0, !1, s)
                })
            }, E.addAdEventWithDuration = function(e, n, t, i, r, s) {
                if (void 0 === e && (e = o.EGAAdAction.Undefined), void 0 === n && (n = o.EGAAdType.Undefined), void 0 === t && (t = ""), void 0 === i && (i = ""), void 0 === r && (r = 0), void 0 === s && (s = {}), v.updateConnectionType(), c.instance.isUnloading) {
                    if (!E.isSdkReady(!0, !0, "Could not add ad event")) return;
                    m.addAdEvent(e, n, t, i, o.EGAAdError.Undefined, r, !0, s)
                } else d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !0, "Could not add ad event") && m.addAdEvent(e, n, t, i, o.EGAAdError.Undefined, r, !0, s)
                })
            }, E.addAdEvent = function(e, n, t, i, r) {
                if (void 0 === e && (e = o.EGAAdAction.Undefined), void 0 === n && (n = o.EGAAdType.Undefined), void 0 === t && (t = ""), void 0 === i && (i = ""), void 0 === r && (r = {}), v.updateConnectionType(), c.instance.isUnloading) {
                    if (!E.isSdkReady(!0, !0, "Could not add ad event")) return;
                    m.addAdEvent(e, n, t, i, o.EGAAdError.Undefined, 0, !1, r)
                } else d.performTaskOnGAThread(function() {
                    E.isSdkReady(!0, !0, "Could not add ad event") && m.addAdEvent(e, n, t, i, o.EGAAdError.Undefined, 0, !1, r)
                })
            }, E.setEnabledInfoLog = function(e) {
                void 0 === e && (e = !1), d.performTaskOnGAThread(function() {
                ...
                d.performTaskOnGAThread(function() {
                    d.setEventProcessInterval(e)
                })
            }, E.startSession = function() {
                if (c.isInitialized()) {
                    var e = d.createTimedBlock();
                    e.async = !0, E.initTimedBlockId = e.id, e.block = function() {
                        c.isEnabled() && c.sessionIsStarted() && d.endSessionAndStopQueue(), E.resumeSessionAndStartQueue()
                    }, d.performTimedBlockOnGAThread(e)
                }
                ...
                c.ensurePersistedStates(), l.setItem(c.getGameKey(), c.DefaultUserIdKey, c.getDefaultId()), c.setInitialized(!0), E.newSession(), c.isEnabled() && d.ensureEventQueueIsRunning()
            }, E.newSession = function() {
                u.i("Starting a new session."), c.validateAndFixCurrentDimensions(), e.instance.requestInit(c.instance.configsHash, E.startNewSessionCallback)
            }, E.startNewSessionCallback = function(e, n) {
                if (e !== g.Ok && e !== g.Created || !n) e == g.Unauthorized ? (u.w("Initialize SDK failed - Unauthorized"), c.instance.initAuthorized = !1) : (e === g.NoResponse || e === g.RequestTimeout ? u.i("Init call (session start) failed - no response. Could be offline or timeout.") : e === g.BadResponse || e === g.JsonEncodeFailed || e === g.JsonDecodeFailed ? u.i("Init call (session start) failed - bad response. Could be bad response from proxy or GA servers.") : e !== g.BadRequest && e !== g.UnknownResponseCode || u.i("Init call (session start) failed - bad request or unknown response."), null == c.instance.sdkConfig ? null != c.instance.sdkConfigCached ? (u.i("Init call (session start) failed - using cached init values."), c.instance.sdkConfig = c.instance.sdkConfigCached) : (u.i("Init call (session start) failed - using default init values."), c.instance.sdkConfig = c.instance.sdkConfigDefault) : u.i("Init call (session start) failed - using cached init values."), c.instance.initAuthorized = !0);
                else {
                    var t = 0;
                    if (n.server_ts) {
                        var i = n.server_ts;
                    ...
                    c.instance.configsHash = n.configs_hash ? n.configs_hash : "", c.instance.abId = n.ab_id ? n.ab_id : "", c.instance.abVariantId = n.ab_variant_id ? n.ab_variant_id : "", l.setItem(c.getGameKey(), c.SdkConfigCachedKey, f.encode64(JSON.stringify(n))), c.instance.sdkConfigCached = n, c.instance.sdkConfig = n, c.instance.initAuthorized = !0
                }
                if (c.instance.clientServerTimeOffset = c.getSdkConfig().time_offset ? c.getSdkConfig().time_offset : 0, c.populateConfigurations(c.getSdkConfig()), !c.isEnabled()) return u.w("Could not start session: SDK is disabled."), void d.stopEventQueue();
                d.ensureEventQueueIsRunning();
                var s = f.createGuid();
                c.instance.sessionId = s, c.instance.sessionStart = c.getClientTsAdjusted(), m.addSessionStartEvent();
                var a = d.getTimedBlockById(E.initTimedBlockId);
                null != a && (a.running = !1), E.initTimedBlockId = -1
            }, E.resumeSessionAndStartQueue = function() {
                c.isInitialized() && (u.i("Resuming session."), c.sessionIsStarted() || E.newSession())
