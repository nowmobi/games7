! function() {
    ...
    if (w.prepareImport = function(e) {
            return (C || e) && (L(), C = !1), R
        }, i && (L(), window.addEventListener("DOMContentLoaded", L)), i) {
        window.addEventListener("error", (function(e) {
            W = e.filename, A = e.error
        }));
    ...
    w.register = function(e, t) {
        ...
        return new Promise((function(r, o) {
            ...
            s.addEventListener("error", (function() {
                ...
                if (document.head.removeChild(s), W === t) o(A);
                else {
                    var e = i.getRegister();
    ...
    w.get = function(e) {
        ...
        var n;
        $ && "Module" === t[$] ? n = t : (n = Object.assign(Object.create(null), t), $ && Object.defineProperty(n, $, {
            value: "Module"
        }));
