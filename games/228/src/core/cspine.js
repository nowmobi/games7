...
CSpine.inherit({
    ...
    changeCostume:function(idCostume){
        ...
        this.changeSprite('weapon_1', 'weapon_' + idCostume);
        this._costume = idCostume;
    },

    changeBox:function(idBox){
        idBox = idBox || this._box;
        this.changeSprite('box_1', 'box_' + idBox);
        this._box = idBox;
    },
    ...
    changeAnim: function(anim) {
        ...
        if (anim != this.currentAnim) {
            ...
            if(this.atlaskey == 'chara_anim'){
                this.changeCostume();
            } else if(this.atlaskey == 'powerup_anim'){
                this.changeBox();
            }
