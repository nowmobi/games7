...
window.addEventListener("load", function() {
    ...
    // Phaser.Device.whenReady(function() {
        ...
        window.createPhaser = function() {
            ...
            game.state.add('cstory', cstory);
            game.state.add('crestaurantRush', crestaurantRush);
            game.state.add('cbazaarTime', cbazaarTime);
            game.state.add('cachievementPage', cachievementPage);
