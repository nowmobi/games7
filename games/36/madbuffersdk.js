 ...
 * @Last Modified time: 2021-02-15 02:52:15
 */
...
function Init() {
    ...
    if (platform === "h5") {
        ...
        if(href.indexOf("gamedistribution.com") >= 0){
            ...
            // 禁用 GameDistribution SDK
            // InitGameDistribution("7fkam0l4bylmbxye14hcn0d4nondqlxx");
        }

        if(href.indexOf("gamemonetize.com") >= 0){
            console.log("gamemonetize.com")
            // 禁用 GameMonetize SDK
            // InitGameMonetize("7fkam0l4bylmbxye14hcn0d4nondqlxx");
        }
    }
}
...
function showInterstitial(showadpercount = 1) {
    // 禁用插页广告
    console.log("Interstitial ads disabled");
    // notifyFramework("showinterstitial",showadpercount);
}

function showReward(showadpercount = 1) {
    // 禁用奖励视频广告
    console.log("Reward ads disabled");
...
function InitGameDistribution(gameKey) {
    // 禁用 GameDistribution SDK 加载
    console.log("GameDistribution SDK disabled");
    /*
    window["GD_OPTIONS"] = {
        "gameId": gameKey,
...
function InitGameMonetize(gameKey) {
    // 禁用 GameMonetize SDK 加载
    console.log("GameMonetize SDK disabled");
    /*
    window.SDK_OPTIONS = {
        gameId: gameKey,
        onEvent: function (a) {
...
function notifyFramework(adtype, showadpercount) {
    ...
    // 禁用所有广告平台调用
    console.log("Ads disabled for platform: " + platform);
...
function GetAdsDataAndShow(packageName, channel = "") {
    // 禁用广告数据获取和显示
    console.log("GetAdsDataAndShow disabled");
    /*
    var platform = GetPlatform();
...
function ShowAdsImage() {
    // 禁用广告图片显示
    console.log("ShowAdsImage disabled");
    /*
    var op = document.createElement("div");
    op.id = "ads";
    ...
    if (platform == "h5") {
        op.style = "position: relative; float:right;width: 72px;height: 72px;background-color: transparent;margin-top:10px;right: 30px;top:30px;z-index: 999";
    }
    else {
        op.style = "position: relative; float:right;width: 60px;height: 60px;background-color: transparent;margin-top:10px;right: 20px;top:20px;z-index: 999";
    }
...
function SetAdsImage(imageurl, url) {
    // 禁用广告图片设置
    console.log("SetAdsImage disabled");
    /*
...
function AddKeyFrame() {
    // 禁用广告动画
    console.log("AddKeyFrame disabled");
    /*
...
function HideAndOpenMarket() {
    // 禁用市场打开功能
    console.log("HideAndOpenMarket disabled");
    // OpenMarket();
...
function OpenMarket() {
    // 禁用市场打开功能
    console.log("OpenMarket disabled");
    /*
