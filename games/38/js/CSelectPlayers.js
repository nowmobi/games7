function CSelectPlayers (){
    ...
    this.init = function(){
        ...
        _oButP1 = new CGfxButton(CANVAS_WIDTH/2-210,CANVAS_HEIGHT/2+0,oSprite,_oContainer);
        _oButP1.addEventListener(ON_MOUSE_DOWN,function(){this.onSelectPlayer(false);},this);
        oSprite = s_oSpriteLibrary.getSprite("but_p2");
        _oButP2 = new CGfxButton(CANVAS_WIDTH/2+210,CANVAS_HEIGHT/2+0,oSprite,_oContainer);
        _oButP2.addEventListener(ON_MOUSE_DOWN,function(){this.onSelectPlayer(true);},this);
        _oText = new createjs.Text(TEXT_SELECT_PLAYERS_MENU,"0px "+PRIMARY_FONT,"#FFFFFF");
        _oText.y = CANVAS_HEIGHT/2-230;
