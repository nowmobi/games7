function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oTitle = new createjs.Text("GAME BY"," 45px "+PRIMARY_FONT, "#ffffff");
        ...
        var oLink = new createjs.Text("www.yo-yo.io"," 45px "+PRIMARY_FONT, "#ffffff");  
		oLink.on("mousedown",this._onlinkButRelease);
		oLink.on("mouseover",this.changePointer,this);
        oLink.y = 25;
    ...
    this._onlinkButRelease = function(){
        window.open("http://www.yo-yo.io", "_blank");
    };
